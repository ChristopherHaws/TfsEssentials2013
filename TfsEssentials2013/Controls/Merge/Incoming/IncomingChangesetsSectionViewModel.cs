...
namespace Spiral.TfsEssentials.Controls.Merge.Incoming
{
	internal class IncomingChangesetsSectionViewModel : ChangesetsSectionViewModelBase
	{
		...
		private bool CanPull()
		{
			try
			{
				return this.Model != null && !this.Model.IsRepositoryOperationInProgress && (!this.Model.IsTfsOperationRunning && this.Model.Branch != null) && this.Model.Branch.HasUpstreamInfo;
			}
			catch (Exception ex)
			{
		...
		{
			if (this.Model != null && this.Model.Branch != null && this.Model.Branch.IncomingChangesets != null)
			{
				this.ChangesetsItemsSource.Reset(this.Model.Branch.IncomingChangesets);
			}
			else
			{
		...
		protected override void UpdateTitle()
		{
			...
			else
			{
				...
				if (this.Model != null && this.Model.Branch != null && !this.Model.Branch.HasUpstreamInfo)
				{
